                                ...
                                <div class="widget-header">
                                    <div class="row">
                                        <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                            <h4>Police Reports List</h4>
                                        </div>
                                        <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                            <input type="button" value="New Report" class="btn btn-outline-primary float-right mr-3" onclick="loadpage('police_report_form.php','page')">
                                        </div>
                                    </div>
                                </div>
    ...
    function do_filter() {
      ...
      function printTable() {
        $.ajax({
            type: "GET",
            url: "utilities.php",
            data: "op=print_reports",
            success: function(msg) {
                var w = window.open('PoliceReports.pdf');
                w.print();
            }
        });
      }
